...
plot(x=time.date.2day,y=hpc.2day$Voltage,type='l',ylab='Voltage',xlab='datetime')
...
plot(x=time.date.2day,y=hpc.2day$Global_reactive_power,type='l',ylab='Global_reactive_power',xlab='datetime')